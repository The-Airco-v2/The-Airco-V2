...
def test_get_presigned_url_can_emit_direct_public_object_url(monkeypatch):
    ...
    assert url == "http://localhost:9000/airco-evidence/snapshots/session/cam/frame.jpg"
...
def test_get_presigned_url_keeps_presigned_mode_when_enabled(monkeypatch):
    ...
    class FakeClient:
        def presigned_get_object(self, bucket: str, object_name: str, expires: timedelta):
            ...
            return (
                "http://minio:9000/airco-evidence/snapshots/session/cam/frame.jpg"
    ...
    assert url.startswith("http://localhost:9000/airco-evidence/snapshots/session/cam/frame.jpg")
